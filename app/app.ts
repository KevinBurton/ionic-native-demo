...
import { BarcodeScannerPage, CameraPage, DeviceMotionPage, GeolocationPage, HomePage, LocalNotificationsPage, VibrationPage, DevicePage } from './pages/pages';
...
class MyApp {
  ...
  constructor(public platform: Platform) {
    ...
    this.pages = [
      ...
      { title: 'Device Info', component: DevicePage, icon: 'information' }
    ];
  }
